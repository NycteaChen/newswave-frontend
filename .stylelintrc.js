module.exports = {
  ...
  rules: {
    'length-zero-no-unit': true, // 禁止 0 + 單位
    'shorthand-property-no-redundant-values': true, // 簡寫屬性
    'declaration-block-no-duplicate-properties': true, // 禁止區塊內重複屬性
    'no-descending-specificity': true, // 禁止在具有較高優先度的選擇氣後出現被其覆蓋的較低優先度的選擇器
    'selector-max-id': 0, // ID 選擇器數量
    'max-nesting-depth': 6,
